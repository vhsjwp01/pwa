...
apt update
apt install -y coreutils git iw make screen curl uuid-runtime hostapd wget rsync ifupdown net-tools jq htop iftop iotop vim bc ethtool bridge-utils wireless-tools firmware-realtek firmware-ralink firmware-iwlwifi 
